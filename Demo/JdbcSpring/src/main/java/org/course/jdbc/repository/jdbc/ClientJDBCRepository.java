...
public class ClientJDBCRepository implements ClientRepository {
    ...
    @Override
    public List<ClientEntity> findAllById(Iterable<String> strings) {
        return null;
    }
    ...
    @Override
    public Optional<ClientEntity> findById(String s) {
    ...
    @Override
    public ClientEntity getOne(String s) {
        return null;
    }
    ...
    @Override
    public ClientEntity getReferenceById(String s) {
        return null;
    }
